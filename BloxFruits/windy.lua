...
game:GetService("RunService").RenderStepped:Connect(function()
    if _G.AutoClick or PerformAttackSequence then
         pcall(function()
            game:GetService'VirtualUser':CaptureController()
...
function TweenTempleLegit()
    ...
    local COMBAT_CONFIG = {
        ...
        hitDelay = 0.00001, -- << Some shit to make sure anti cheat won't reach and ping won't grow
        randomization = {
            range = {
                min = -2, 
                max = 2
            }, -- << Some shit to make sure anti cheat won't reach and ping won't grow
            timing = {
                min = -0.05, 
                max = 0.05
            } -- << Some shit to make sure anti cheat won't reach and ping won't grow
...
local Section = M:AddSection({
    Name = "PerformAttackSequence :"
})

M:AddToggle({
    Name = "PerformAttackSequence",
    Default = true,
    Flag = "PerformAttackSequence",
    Save = false,
    Callback = function(Value)
        _G.PerformAttackSequence = Value
    end    
})
--[[
...
M:AddDropdown({
	Name = "PerformAttackSequence Delay",
	Default = "0.5",
	Options = AttackList,
    Flag = "PerformAttackSequence Delay",
    Save = true,
	Callback = function(Value)
		_G.PerformAttackSequenceDelay = Value
	end    
})
spawn(function()
    while wait(.1) do
        if _G.PerformAttackSequenceDelay then
            pcall(function()
                if _G.PerformAttackSequenceDelay == "0" then
                    _G.PerformAttackSequenceDelay = 0
                elseif _G.PerformAttackSequenceDelay == "0.1" then
                    _G.PerformAttackSequenceDelay = 0.1
                elseif _G.PerformAttackSequenceDelay == "0.175" then
                    _G.PerformAttackSequenceDelay = 0.175
                elseif _G.PerformAttackSequenceDelay == "0.2" then
                    _G.PerformAttackSequenceDelay = 0.2
                elseif _G.PerformAttackSequenceDelay == "0.25" then
                    _G.PerformAttackSequenceDelay = 0.25
                elseif _G.PerformAttackSequenceDelay == "0.3" then
                    _G.PerformAttackSequenceDelay = 0.3
                elseif _G.PerformAttackSequenceDelay == "0.35" then
                    _G.PerformAttackSequenceDelay = 0.35
                elseif _G.PerformAttackSequenceDelay == "0.4" then
                    _G.PerformAttackSequenceDelay = 0.5
                elseif _G.PerformAttackSequenceDelay == "0.45" then
                    _G.PerformAttackSequenceDelay = 0.45
                elseif _G.PerformAttackSequenceDelay == "0.5" then
                    _G.PerformAttackSequenceDelay = 0.5
                elseif _G.PerformAttackSequenceDelay == "0.55" then
                    _G.PerformAttackSequenceDelay = 0.55
                elseif _G.PerformAttackSequenceDelay == "0.6" then
                    _G.PerformAttackSequenceDelay = 0.6
                elseif _G.PerformAttackSequenceDelay == "0.65" then
                    _G.PerformAttackSequenceDelay = 0.65
                elseif _G.PerformAttackSequenceDelay == "0.7" then
                    _G.PerformAttackSequenceDelay = 0.7
                elseif _G.PerformAttackSequenceDelay == "0.75" then
                    _G.PerformAttackSequenceDelay = 0.75
                elseif _G.PerformAttackSequenceDelay == "0.8" then
                    _G.PerformAttackSequenceDelay = 0.8
                elseif _G.PerformAttackSequenceDelay == "0.85" then
                    _G.PerformAttackSequenceDelay = 0.85
                elseif _G.PerformAttackSequenceDelay == "0.9" then
                    _G.PerformAttackSequenceDelay = 0.9
                elseif _G.PerformAttackSequenceDelay == "0.95" then
                    _G.PerformAttackSequenceDelay = 0.95
                elseif _G.PerformAttackSequenceDelay == "1" then
                    _G.PerformAttackSequenceDelay = 1
                end
            end)
        end
    end
...
spawn(function()
    while wait(.1) do
        if _G.PerformAttackSequence then
            pcall(function()
                repeat task.wait(_G.PerformAttackSequenceDelay)
                    AttackHit()
                until not _G.PerformAttackSequence
            end)
        end
    end
end)
